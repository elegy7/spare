...
// 错误提示方法
export function showTip($input, $tip) {}
// 移除错误提示
export function removeTip($input) {}
// 初始化
                ...
                if (Object.keys(rule).length) {
                    ...
                    if (!bool) {
                        ...
                        for (var index in param) {
                            rule.message = rule.message.replace('{' + index + '}', param[i])
                        }
                        $this.addClass('ee-invalid')
                        $invalid.text(rule.message)
                        $this.after($invalid)
                        showTip($this, $invalid)
                        break
                    }
                }
            }
        ...
        $valid.on(conf.evt, function(e) {
            ...
            timeout(function() {
                ...
                if (requiredIndex !== -1 && ($.isEmptyObject(inputVal) || inputVal === '0.00')) {
                    ...
                    // 遍历Rules数组里的所有自定义验证
                    var inRule = doValid.call(this, rules, options, $this, $invalid, false)
